...
class UsersContainer extends React.Component {
  dataRequest = (value) => {
    fetch(
      `https://cors-anywhere.herokuapp.com///www.filltext.com/?rows=${value}&id={number|1000}&firstName={firstName}&delay=3&lastName={lastName}&email={email}&phone={phone|(xxx)xxx-xx-xx}&address={addressObject}&description={lorem|32}`
    )
      .then((res) => res.json())
      .then((data) => {
